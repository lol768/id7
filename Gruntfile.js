module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ...
      bundle: {
        src: [
          ...
          'js/vendor/bootstrap-3.3.5/transition.js',
          'js/vendor/bootstrap-3.3.5/alert.js',
          'js/vendor/bootstrap-3.3.5/button.js',
          'js/vendor/bootstrap-3.3.5/carousel.js',
          'js/vendor/bootstrap-3.3.5/collapse.js',
          'js/vendor/bootstrap-3.3.5/dropdown.js',
          'js/vendor/bootstrap-3.3.5/modal.js',
          'js/vendor/bootstrap-3.3.5/tooltip.js',
          'js/vendor/bootstrap-3.3.5/popover.js',
          'js/vendor/bootstrap-3.3.5/scrollspy.js',
          'js/vendor/bootstrap-3.3.5/tab.js',
    ...
    less: {
      ...
      compileLite: {
        options: {
          ...
          sourceMapFilename: 'dist/css/<%= pkg.name %>.lite.css.map'
        },
        src: 'less/id7.lite.less',
        dest: 'dist/css/<%= pkg.name %>.lite.css'
      },
      compileDefaultTheme: {
        options: {
          strictMath: true,
    ...
    cssmin: {
      ...
      minifyLite: {
        src: 'dist/css/<%= pkg.name %>.lite.css',
        dest: 'dist/css/<%= pkg.name %>.lite.min.css'
      },
      minifyDefaultTheme: {
        src: 'dist/css/<%= pkg.name %>-default-theme.css',
    ...
    copy: {
      ...
      vendorjs: {
        expand: true,
        src: ['js/vendor/*', '!js/vendor/bootstrap-3.3.5'],
        dest: 'dist/'
      },
      docs: {
        expand: true,
  ...
  // CSS distribution.
  grunt.registerTask('less-compile', ['less:compileCore', 'less:compileLite', 'less:compileDefaultTheme', 'less:compileID6a']);
  grunt.registerTask('dist-css', ['less-compile', 'autoprefixer:core', 'autoprefixer:defaultTheme', 'autoprefixer:id6a', 'csscomb:dist', 'cssmin:minifyCore', 'cssmin:minifyLite', 'cssmin:minifyDefaultTheme', 'cssmin:minifyID6a']);
